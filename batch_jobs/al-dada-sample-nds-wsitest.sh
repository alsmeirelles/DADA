...
time python3 main.py -i -v --al -predst /ocean/projects/asc130006p/alsm/active-learning/data/nds300 -split 0.9 0.01 0.09 -net Xception -data CellRep -init_train 500 -ac_steps 20 -dropout_steps 20 -ac_function kmng_uncert -un_function bayesian_bald -acquire 200 -d -e 50 -b 96 -tdim 240 240 -out logs/ -cpu 15 -gpu 1 -tn -sv -nsw -wpath results/$DIRID -model_dir results/$DIRID -logdir results/$DIRID -cache results/$DIRID -sample 2000 -spool 2 -load_train -wsi_split 5 -pred_size 15000 -phi 2 -k -lr 0.0005 -pca 50 -f1 30 -tnet Xception -tnpred 2 -tnphi 1   
